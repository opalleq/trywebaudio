...
// Load file
loadFile(''); // your file here

const play = function(decodedData) {
...
const getDuration = function(decodedData) {
	const minutes = Math.floor(decodedData.duration / 60);
	let seconds = ((decodedData.duration % 60)).toFixed(0);
